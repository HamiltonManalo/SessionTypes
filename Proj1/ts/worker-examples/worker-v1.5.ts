...
let executionContext = new SessionTypeWorkerExecutionContext(self); 
executionContext.onReceiveMessageA((worker) => {
    //dologic
    worker.reply()
    //reply string with string returns nothing because this scope dies 
} )
